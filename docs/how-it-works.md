...
Bullshit Detector is a Manifest V3 extension built with [WXT](https://wxt.dev) and TypeScript.
...
| Post | Index | AI |
| --- | --- | --- |
| "I got rejected from 47 jobs. Then a janitor told me…" | 99% 🐂 Certified BS | 🤔 62% |
| "𝗔𝗜 𝘄𝗼𝗻'𝘁 𝗿𝗲𝗽𝗹𝗮𝗰𝗲 𝘆𝗼𝘂. Here's the thing —…" | 97% 🐂 Certified BS | 🤖 99% |
| "In today's fast-paced world, leveraging synergies…" | 96% 🐂 Certified BS | 🤖 92% |
| "Starting a new position as Senior QA at Globex! Thanks to everyone…" | 77% 🏭 Heavy fluff | ✍️ 22% |
| Meetup recap with a link to slides | 63% 🎤 Thought leader | ✍️ 5% |
| "ok so the coffee machine has been broken for 3 weeks…" | 41% 🧁 Some fluff | ✍️ 1% |
...
└── lib/
    ...
    │   ├── scoring.ts         # signals → Bullshit Index, tropes

...
/**
 * 🥚 The zero-bullshit list. Posts by these profiles skip the model entirely: whatever they
 ...
 */
export const ZERO_BULLSHIT_AUTHORS: ReadonlySet<string> = new Set([
  "in:aliaksei-horbel-5b42a1113", // the author of this extension, obviously
]);

export function isZeroBullshit(author: string | undefined): boolean {
  return !!author && ZERO_BULLSHIT_AUTHORS.has(author.toLowerCase());
}

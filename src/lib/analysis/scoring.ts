...
/** Defaults for the sliders in the popup. 1 means "a post with this is pure bullshit". */
...
export function bullshitIndex(
  ...
  // A genre the reader counts as bullshit weighs on every post of that genre.

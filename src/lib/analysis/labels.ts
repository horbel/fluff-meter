...
export const VERDICTS: readonly Verdict[] = [
  { min: 90, label: "Certified BS", emoji: "🐂", hue: 0 },
  { min: 75, label: "Heavy fluff", emoji: "🏭", hue: 12 },
  { min: 55, label: "Thought leader", emoji: "🎤", hue: 28 },
  { min: 35, label: "Some fluff", emoji: "🧁", hue: 45 },
...
export const LEGEND_VERDICT: Verdict = { min: 0, label: "Zero BS", emoji: "🦄", hue: 275 };

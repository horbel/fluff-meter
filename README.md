...
**Rates every LinkedIn post on a 0–100% Bullshit Index.**

[![CI](https://github.com/horbel/bullshit-detector/actions/workflows/ci.yml/badge.svg)](https://github.com/horbel/bullshit-detector/actions/workflows/ci.yml)
[![License: MIT](https://img.shields.io/badge/license-MIT-blue.svg)](LICENSE)
[![Buy me a coffee](https://img.shields.io/badge/☕-buy%20me%20a%20coffee-ffdd00)](https://buymeacoffee.com/horbel)

<img src="docs/screenshot.png" width="600" alt="A LinkedIn post with a badge: 99%, Certified BS" />

</div>

Scroll LinkedIn as usual. Every post gets a small badge that tells you:

- **how much bullshit it is**, from 🧠 *Pure signal* to 🐂 *Certified BS*;
...
The popup shows how much of your feed was bullshit today, this week or this month.

It rates posts, not people.

## Install

1. Download the zip from the [latest release](https://github.com/horbel/bullshit-detector/releases/latest)
   and unzip it.
...
Every tag has a slider from 🏆 (fine by me) to 🐂 (pure bullshit). Think event posts are
nonsense? Drag *Event* to 🐂. Or pick a preset: **Engineer**, **Recruiter** or **Pragmatist**.
...
LinkedIn ✅ · X · Threads · Chrome Web Store
